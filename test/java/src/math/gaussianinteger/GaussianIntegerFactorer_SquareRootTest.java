...
public class GaussianIntegerFactorer_SquareRootTest {
	...
	public GaussianIntegerFactorer_SquareRootTest(GaussianInteger sum, GaussianInteger gaussianInteger) {
	...
	@Before
	public void setUp() {
		gaussianIntegerFactorer = new GaussianIntegerFactorer_SquareRoot();
	}
}
